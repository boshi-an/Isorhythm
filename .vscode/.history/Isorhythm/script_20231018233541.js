...
function updateLetters(circleId, inputText, bias) {
    ...
    if (circleId == "circle1") {
        ...
        for (let i = 0; i < inputText.length; i++) {
            const angle = (i / inputText.length) * 360;
            const imgElem = document.createElement('imageArea');
...
document.getElementById('input1').addEventListener('input', function () { updateLetters('circle1', document.getElementById('input1').value, 0));
